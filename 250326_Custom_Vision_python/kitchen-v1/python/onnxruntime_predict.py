...
MODEL_FILENAME = '250326_Custom_Vision\kitchen-v1\model.onnx'
LABELS_FILENAME = '250326_Custom_Vision\kitchen-v1\labels.txt'
...
if __name__ == '__main__':
    main('250326_Custom_Vision/test/test_image.jpg')
